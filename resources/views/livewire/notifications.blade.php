<div>
    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-sm font-bold text-navy-900">Semua Notifikasi</h2>
        ...
        <div class="space-y-4">
            @forelse($notifications as $notification)
                <div class="group flex items-start justify-between p-4 rounded-2xl border transition-all {{ $notification->read_at ? 'bg-slate-50 border-slate-100' : 'bg-orange-50/30 border-orange-100' }}">
